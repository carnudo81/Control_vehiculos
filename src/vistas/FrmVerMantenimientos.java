...
public class FrmVerMantenimientos extends javax.swing.JInternalFrame {

    public static String vm;
    
    public FrmVerMantenimientos() {
        initComponents();
        vm = "vm";
    }
    ...
    private void initComponents() {
        ...
        lblVehiculo.setText("VER MANTENIMIENTO DE VEHICULO");
        ...
        pnlTablaVehiReg.add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 120, 1150, 390));
